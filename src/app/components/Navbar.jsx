...
export default function Navbar({showMenu, setShowMenu, handleClick}) {
  ...
  return (
    <nav className="">
      <ul className="flex justify-between h-[100px] bg-white  text-red-800 items-center text-sm fixed top-0 right-0 left-0 z-50">
        ...
        <Link href='/login' className="hidden md:block text-white bg-orange-600 p-2 hover:bg-orange-700 hover:text-[#fff] mr-5 rounded-md">Login / Signup</Link>
      </ul>
